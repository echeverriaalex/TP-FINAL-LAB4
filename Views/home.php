    ...
    <div class= "row">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <img class="img-fluid" src= "<?php echo FRONT_ROOT.VIEWS_PATH ?>/img/equipo.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item" data-bs-interval="2000">
        <img class="img-fluid" src= "<?php echo FRONT_ROOT.VIEWS_PATH ?>/img/equipo2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img class="img-fluid" src= "<?php echo FRONT_ROOT.VIEWS_PATH ?>/img/equipo3.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
